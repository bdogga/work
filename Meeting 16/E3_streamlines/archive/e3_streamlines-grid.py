...
LE_TE = pd.read_csv("/home/bharadwaj/work/Meeting_10/Meeting docs/Chris Feldman Docs/E3_trial1/E3_streamlines/wo_duplicate_LE_TE_coordinates.dat",na_values = None,skipinitialspace=True,skiprows=[0],sep="\s+",keep_default_na=False,names = ["xLE","rLE","xTE","rTE"])
...
scaled_hub = scaled_hub*dist_LE0_TE0*8
translated_hub = scaled_hub.copy()
xhub_TE_diff = LE_TE.iloc[17,2] - translated_hub.iloc[127,0]
yhub_TE_diff = LE_TE.iloc[17,3] - translated_hub.iloc[127,1]
#print(xhub_TE_diff)
#print(yhub_TE_diff)
...
interp_LE_df = pd.read_csv("/home/bharadwaj/work/Meeting_10/Meeting docs/Chris Feldman Docs/E3_trial1/E3_streamlines/interp_LE_df.dat",na_values = None,skipinitialspace=True,sep="\s+")
#print(interp_LE_df)
interp_TE_df = pd.read_csv("/home/bharadwaj/work/Meeting_10/Meeting docs/Chris Feldman Docs/E3_trial1/E3_streamlines/interp_TE_df.dat",na_values = None,skipinitialspace=True,sep="\s+")
#print(interp_TE_df)
...
streamlines_final_df = streamlines_final_df.append(interp_LE_df, ignore_index = True)
...
streamlines_final_df = streamlines_final_df.append(interp_TE_df, ignore_index = True)
