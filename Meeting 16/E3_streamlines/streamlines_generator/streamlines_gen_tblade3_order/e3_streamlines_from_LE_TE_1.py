...
hub = pd.read_csv("hub_export.dat",na_values = None,skipinitialspace=True,skiprows=[0],sep="\s+",keep_default_na=False,names = ["X","Y","Z"])
...
LE_TE = pd.read_csv("unique_LE_TE_coordinates.dat",na_values = None,skipinitialspace=True,skiprows=[0],sep="\s+",keep_default_na=False,names = ["xLE","rLE","xTE","rTE"])
...
#print(casing.head())
#   Part 1 of casing
casing.iloc[:95,1] = LE_TE.iloc[0,1]+30e-3
...
def streamline_coordinates_construct(x_iloc):
   ...
   if x_iloc<110:
      ...
      streamlines_sect_1_z = [0.0] * len(streamlines_sect_1_x)
      streamlines_sect_next_df = pd.DataFrame(list(zip(streamlines_sect_1_x, streamlines_sect_1_y, streamlines_sect_1_z)), columns =['X', 'Y', 'Z'], dtype=float)
      #streamlines_sect_next_df = streamlines_sect_next_df.sort_values(by='Y', ascending=False)
   return streamlines_sect_next_df

list_x_vals = [np.arange(60, 209, 10)]
#print(list_x_vals)

#Part1: Generate the points from LE and LE. These input to the function are row numbers in hub file.
...
streamlines_01_tblade3 = pd.DataFrame(list(zip(streamline_18_coordiantes['X'], streamline_18_coordiantes['Y'])), columns =['x_s', 'r_s'], dtype=float)
...
streamlines_df = streamlines_df.append(zero_df, ignore_index = True)
streamlines_02_tblade3 = pd.DataFrame(list(zip(streamline_17_coordiantes['X'], streamline_17_coordiantes['Y'])), columns =['x_s', 'r_s'], dtype=float)
...
streamlines_df = streamlines_df.append(zero_df, ignore_index = True)
streamlines_03_tblade3 = pd.DataFrame(list(zip(streamline_16_coordiantes['X'], streamline_16_coordiantes['Y'])), columns =['x_s', 'r_s'], dtype=float)
...
streamlines_df = streamlines_df.append(zero_df, ignore_index = True)
streamlines_04_tblade3 = pd.DataFrame(list(zip(streamline_15_coordiantes['X'], streamline_15_coordiantes['Y'])), columns =['x_s', 'r_s'], dtype=float)
...
streamlines_df = streamlines_df.append(zero_df, ignore_index = True)
streamlines_05_tblade3 = pd.DataFrame(list(zip(streamline_14_coordiantes['X'], streamline_14_coordiantes['Y'])), columns =['x_s', 'r_s'], dtype=float)
...
streamlines_df = streamlines_df.append(zero_df, ignore_index = True)
streamlines_06_tblade3 = pd.DataFrame(list(zip(streamline_13_coordiantes['X'], streamline_13_coordiantes['Y'])), columns =['x_s', 'r_s'], dtype=float)
...
streamlines_df = streamlines_df.append(zero_df, ignore_index = True)
streamlines_07_tblade3 = pd.DataFrame(list(zip(streamline_12_coordiantes['X'], streamline_12_coordiantes['Y'])), columns =['x_s', 'r_s'], dtype=float)
...
streamlines_df = streamlines_df.append(zero_df, ignore_index = True)
streamlines_08_tblade3 = pd.DataFrame(list(zip(streamline_11_coordiantes['X'], streamline_11_coordiantes['Y'])), columns =['x_s', 'r_s'], dtype=float)
...
streamlines_df = streamlines_df.append(zero_df, ignore_index = True)
streamlines_09_tblade3 = pd.DataFrame(list(zip(streamline_10_coordiantes['X'], streamline_10_coordiantes['Y'])), columns =['x_s', 'r_s'], dtype=float)
...
streamlines_df = streamlines_df.append(zero_df, ignore_index = True)
streamlines_10_tblade3 = pd.DataFrame(list(zip(streamline_09_coordiantes['X'], streamline_09_coordiantes['Y'])), columns =['x_s', 'r_s'], dtype=float)
...
streamlines_df = streamlines_df.append(zero_df, ignore_index = True)
streamlines_11_tblade3 = pd.DataFrame(list(zip(streamline_08_coordiantes['X'], streamline_08_coordiantes['Y'])), columns =['x_s', 'r_s'], dtype=float)
...
streamlines_df = streamlines_df.append(zero_df, ignore_index = True)
streamlines_12_tblade3 = pd.DataFrame(list(zip(streamline_07_coordiantes['X'], streamline_07_coordiantes['Y'])), columns =['x_s', 'r_s'], dtype=float)
...
streamlines_df = streamlines_df.append(zero_df, ignore_index = True)
streamlines_13_tblade3 = pd.DataFrame(list(zip(streamline_06_coordiantes['X'], streamline_06_coordiantes['Y'])), columns =['x_s', 'r_s'], dtype=float)
...
streamlines_df = streamlines_df.append(zero_df, ignore_index = True)
streamlines_14_tblade3 = pd.DataFrame(list(zip(streamline_05_coordiantes['X'], streamline_05_coordiantes['Y'])), columns =['x_s', 'r_s'], dtype=float)
...
streamlines_df = streamlines_df.append(zero_df, ignore_index = True)
streamlines_15_tblade3 = pd.DataFrame(list(zip(streamline_04_coordiantes['X'], streamline_04_coordiantes['Y'])), columns =['x_s', 'r_s'], dtype=float)
...
streamlines_df = streamlines_df.append(zero_df, ignore_index = True)
streamlines_16_tblade3 = pd.DataFrame(list(zip(streamline_03_coordiantes['X'], streamline_03_coordiantes['Y'])), columns =['x_s', 'r_s'], dtype=float)
...
streamlines_df = streamlines_df.append(zero_df, ignore_index = True)
streamlines_17_tblade3 = pd.DataFrame(list(zip(streamline_02_coordiantes['X'], streamline_02_coordiantes['Y'])), columns =['x_s', 'r_s'], dtype=float)
...
streamlines_df = streamlines_df.append(zero_df, ignore_index = True)
streamlines_18_tblade3 = pd.DataFrame(list(zip(streamline_01_coordiantes['X'], streamline_01_coordiantes['Y'])), columns =['x_s', 'r_s'], dtype=float)
