...
if __name__ == "__main__":
    ...
    indeps.add_output('t',0.17)#0.16109697)#0.10)   #0.991080592614
    indeps.add_output('LE_radius', 4.0)#5.01766249)#5.89894475)#5.9)
    indeps.add_output('u_max',0.30)#0.3312661)#0.40180786)#0.29)
    indeps.add_output('t_TE', 0.015)#0.03259426)#0.00023444)#0.00001)
    indeps.add_output('in_beta',29.52062563)#4.4698513)#0.0142108)#0.00001)
    indeps.add_output('out_beta',-69.91192880)#-4.49380167)#-0.01422172)#-0.00001)
    ...
    indeps.add_output('dydxTE',0.0)#-0.00597116)#-0.14570056)#0.0)
