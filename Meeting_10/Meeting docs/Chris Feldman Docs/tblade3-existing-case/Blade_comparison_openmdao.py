...
foil1 = pd.read_csv('/home/bharadwaj/work/Meeting_10/Meeting docs/Chris Feldman Docs/tblade3-existing-case/tblade3-existing-case.dat',na_values = None,skipinitialspace=True,skiprows=[0],sep="\s+",keep_default_na=False,names = ["X","Y"])
...
foil2 = pd.read_csv('/home/bharadwaj/work/Meeting_10/Meeting docs/Chris Feldman Docs/tblade3-existing-case/uvblade.1.2.TT', sep = " ", encoding = 'ISO-8859-1',na_values = None,skipinitialspace=True,keep_default_na=False,names=["X","Y"])
