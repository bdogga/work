...
#Create an output file such that you can paste the hub, streamlines and casing data into 3dbgb input file. The order is: Hub, Streamlines, casing.
list_0 = [0]
...
streamlines_df = streamlines_df.append(zero_df, ignore_index = True)
streamlines_19_tblade3 = pd.DataFrame(list(zip(streamline_19_coordiantes['X'], streamline_19_coordiantes['Y'])), columns =['x_s', 'r_s'], dtype=float)
streamlines_19_tblade3 = streamlines_19_tblade3.round(7)
streamlines_df = streamlines_df.append(streamlines_19_tblade3, ignore_index = True)
streamlines_df = streamlines_df.append(zero_df, ignore_index = True)
streamlines_20_tblade3 = pd.DataFrame(list(zip(streamline_20_coordiantes['X'], streamline_20_coordiantes['Y'])), columns =['x_s', 'r_s'], dtype=float)
streamlines_20_tblade3 = streamlines_20_tblade3.round(7)
streamlines_df = streamlines_df.append(streamlines_20_tblade3, ignore_index = True)
streamlines_df = streamlines_df.append(zero_df, ignore_index = True)
