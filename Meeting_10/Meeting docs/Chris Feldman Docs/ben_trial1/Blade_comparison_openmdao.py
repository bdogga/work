...
foil1 = pd.read_csv('/home/christopher/Desktop/Research/fan-curve_layer05_edited_for_chris.dat',na_values = None,skipinitialspace=True,skiprows=[0],sep="\s+",keep_default_na=False,names = ["X","Y"])
